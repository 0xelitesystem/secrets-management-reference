...
- `01-what-counts-as-a-secret.md` recognizing what needs protecting
- `02-keep-secrets-out-of-code.md` the places secrets must never go
- `03-environment-variables-and-vaults.md` where secrets should live instead
- `04-rotation-and-least-privilege.md` limiting the blast radius of any one secret
- `05-what-to-do-when-one-leaks.md` responding when a secret is exposed
